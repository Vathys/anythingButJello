    ...
    public int Problem5(){
        ...
        for(int i = 0; i < array.length; i++){
            for(int j = 0; j < NUM1.length; j++){
                ...
                int aft = array[i];
                if(pre != aft){
                    num1 = Helper_Class.switchNum(pre, -1, num1);
                    num2 = Helper_Class.switchNum(pre, -1, num2);
                    answer = Helper_Class.switchNum(pre, -1, answer);
                    num1 = Helper_Class.switchNum(aft, -2, num1);
                    num2 = Helper_Class.switchNum(aft, -2, num2);
                    answer = Helper_Class.switchNum(aft, -2, answer);

                    num1 = Helper_Class.switchNum(-1, aft, num1);
                    num2 = Helper_Class.switchNum(-1, aft, num2);
                    answer = Helper_Class.switchNum(-1, aft, answer);
                    num1 = Helper_Class.switchNum(-2, pre, num1);
                    num2 = Helper_Class.switchNum(-2, pre, num2);
                    answer = Helper_Class.switchNum(-2, pre, answer);
                }
